...
class PhotosOfMeRootAdapter(val imageClicked : (ClickAction)->Unit,
                            val showMoreClicked : (Data)->Unit
                            , val arrayListOfImagessValues: ArrayList<Data>,
                            val util: Util
                       // val itemBuy : (Any)->Unit,
) : RecyclerView.Adapter<PhotosOfMeRootAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(val imageItemadaptorBinding: PhotosRootItemBinding) :
        ...
        fun bindItems(
            ...
            imageItemadaptorBinding.userName.text = itemData.uploaderName?:""
        /*    Glide.with(imageItemadaptorBinding.userName.context).load(itemData.r0esizedLink)
        ...
        */
            ...
            val adapter = PhotosOfMeAdapter(imageClicked,itemData,itemData.photosCount,showMoreClicked)
